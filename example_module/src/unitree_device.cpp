...
#include <example_module/unitree_device.h>
...
{
    auto devInfo = DeviceInfo("daq.dog://UnitreeGO2_MySerial", "Robot dog");
...
//void ExampleDevice::initSignals()
//{
//    sig1 = Signal(context, this->signals, "Sig1");
//}
