/****************************************************************
  ...
  Source: MotorState.hpp
  Cyclone DDS: v0.11.0

*****************************************************************/
#ifndef DDSCXX_MOTORSTATE_HPP_91547D0816A9C2BA6B2B5BB63E5694B8
#define DDSCXX_MOTORSTATE_HPP_91547D0816A9C2BA6B2B5BB63E5694B8
...
public:
  ...
  void reserve(std::array<uint32_t, 2>&& _val_) { this->reserve_ = std::move(_val_); }
...
namespace {
  static const volatile propvec &properties___unitree_go__msg__dds___MotorState_ = get_type_props<::unitree_go::msg::dds_::MotorState_>();
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::unitree_go::msg::dds_::MotorState_& instance, const entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::unitree_go::msg::dds_::MotorState_& instance, key_mode key) {
  const auto &props = get_type_props<::unitree_go::msg::dds_::MotorState_>();
  str.set_mode(cdr_stream::stream_mode::write, key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::unitree_go::msg::dds_::MotorState_& instance, const entity_properties_t *props) {
  (void)instance;
  member_id_set member_ids;
  if (!streamer.start_struct(*props))
    return false;
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::unitree_go::msg::dds_::MotorState_& instance, key_mode key) {
  const auto &props = get_type_props<::unitree_go::msg::dds_::MotorState_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::unitree_go::msg::dds_::MotorState_& instance, const entity_properties_t *props) {
  (void)instance;
  member_id_set member_ids;
  if (!streamer.start_struct(*props))
    return false;
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::unitree_go::msg::dds_::MotorState_& instance, key_mode key) {
  const auto &props = get_type_props<::unitree_go::msg::dds_::MotorState_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::unitree_go::msg::dds_::MotorState_& instance, const entity_properties_t *props) {
  (void)instance;
  member_id_set member_ids;
  if (!streamer.start_struct(*props))
    return false;
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::unitree_go::msg::dds_::MotorState_& instance, key_mode key) {
  const auto &props = get_type_props<::unitree_go::msg::dds_::MotorState_>();
...
#endif // DDSCXX_MOTORSTATE_HPP_91547D0816A9C2BA6B2B5BB63E5694B8
