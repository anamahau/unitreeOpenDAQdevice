...
*****************************************************************/
#ifndef DDSCXX_LOWSTATE_HPP_8A50F0B73A6485A28B9247D947C4A47E
#define DDSCXX_LOWSTATE_HPP_8A50F0B73A6485A28B9247D947C4A47E
    ...
    namespace msg
    {
        namespace dds_
        {
            ...
            public:
                ...
                void head(std::array<uint8_t, 2>&& _val_) { this->head_ = std::move(_val_); }
                ...
                void sn(std::array<uint32_t, 2>&& _val_) { this->sn_ = std::move(_val_); }
                ...
                void version(std::array<uint32_t, 2>&& _val_) { this->version_ = std::move(_val_); }
                ...
                void motor_state(std::array<::unitree_go::msg::dds_::MotorState_, 20>&& _val_) { this->motor_state_ = std::move(_val_); }
                ...
                void bms_state(::unitree_go::msg::dds_::BmsState_&& _val_) { this->bms_state_ = std::move(_val_); }
                ...
                void foot_force_est(std::array<int16_t, 4>&& _val_) { this->foot_force_est_ = std::move(_val_); }
                ...
                void wireless_remote(std::array<uint8_t, 40>&& _val_) { this->wireless_remote_ = std::move(_val_); }
                ...
                void fan_frequency(std::array<uint16_t, 4>&& _val_) { this->fan_frequency_ = std::move(_val_); }
        ...
        namespace cyclonedds {
            namespace core {
                namespace cdr {
                    ...
                    namespace {
                        static const volatile propvec& properties___unitree_go__msg__dds___LowState_ = get_type_props<::unitree_go::msg::dds_::LowState_>();
                    }

                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool write(T& streamer, const ::unitree_go::msg::dds_::LowState_& instance, const entity_properties_t* props) {
                        (void)instance;
                    ...
                    bool write(S& str, const ::unitree_go::msg::dds_::LowState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::LowState_>();
                        str.set_mode(cdr_stream::stream_mode::write, key);
                        return write(str, instance, props.data());
                    }

                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool read(T& streamer, ::unitree_go::msg::dds_::LowState_& instance, const entity_properties_t* props) {
                        (void)instance;
                        member_id_set member_ids;
                        if (!streamer.start_struct(*props))
                            return false;
                    ...
                    template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
                    bool read(S& str, ::unitree_go::msg::dds_::LowState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::LowState_>();
                    ...
                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool move(T& streamer, const ::unitree_go::msg::dds_::LowState_& instance, const entity_properties_t* props) {
                        (void)instance;
                        member_id_set member_ids;
                        if (!streamer.start_struct(*props))
                            return false;
                    ...
                    template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
                    bool move(S& str, const ::unitree_go::msg::dds_::LowState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::LowState_>();
                    ...
                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool max(T& streamer, const ::unitree_go::msg::dds_::LowState_& instance, const entity_properties_t* props) {
                        (void)instance;
                        member_id_set member_ids;
                        if (!streamer.start_struct(*props))
                            return false;
                    ...
                    template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
                    bool max(S& str, const ::unitree_go::msg::dds_::LowState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::LowState_>();
...
#endif // DDSCXX_LOWSTATE_HPP_8A50F0B73A6485A28B9247D947C4A47E
