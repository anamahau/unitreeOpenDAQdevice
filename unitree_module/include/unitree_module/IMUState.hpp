...
*****************************************************************/
#ifndef DDSCXX_IMUSTATE_HPP_49780616E11A246083E7F5046B4F3895
#define DDSCXX_IMUSTATE_HPP_49780616E11A246083E7F5046B4F3895
    ...
    namespace msg
    {
        namespace dds_
        {
            ...
            public:
                ...
                void quaternion(std::array<float, 4>&& _val_) { this->quaternion_ = std::move(_val_); }
                ...
                void gyroscope(std::array<float, 3>&& _val_) { this->gyroscope_ = std::move(_val_); }
                ...
                void accelerometer(std::array<float, 3>&& _val_) { this->accelerometer_ = std::move(_val_); }
        ...
        namespace cyclonedds {
            namespace core {
                namespace cdr {
                    ...
                    namespace {
                        static const volatile propvec& properties___unitree_go__msg__dds___IMUState_ = get_type_props<::unitree_go::msg::dds_::IMUState_>();
                    }

                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool write(T& streamer, const ::unitree_go::msg::dds_::IMUState_& instance, const entity_properties_t* props) {
                        (void)instance;
                    ...
                    bool write(S& str, const ::unitree_go::msg::dds_::IMUState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::IMUState_>();
                        str.set_mode(cdr_stream::stream_mode::write, key);
                        return write(str, instance, props.data());
                    }

                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool read(T& streamer, ::unitree_go::msg::dds_::IMUState_& instance, const entity_properties_t* props) {
                        (void)instance;
                        member_id_set member_ids;
                        if (!streamer.start_struct(*props))
                            return false;
                    ...
                    template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
                    bool read(S& str, ::unitree_go::msg::dds_::IMUState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::IMUState_>();
                    ...
                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool move(T& streamer, const ::unitree_go::msg::dds_::IMUState_& instance, const entity_properties_t* props) {
                        (void)instance;
                        member_id_set member_ids;
                        if (!streamer.start_struct(*props))
                            return false;
                    ...
                    template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
                    bool move(S& str, const ::unitree_go::msg::dds_::IMUState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::IMUState_>();
                    ...
                    template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
                    bool max(T& streamer, const ::unitree_go::msg::dds_::IMUState_& instance, const entity_properties_t* props) {
                        (void)instance;
                        member_id_set member_ids;
                        if (!streamer.start_struct(*props))
                            return false;
                    ...
                    template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
                    bool max(S& str, const ::unitree_go::msg::dds_::IMUState_& instance, key_mode key) {
                        const auto& props = get_type_props<::unitree_go::msg::dds_::IMUState_>();
...
#endif // DDSCXX_IMUSTATE_HPP_49780616E11A246083E7F5046B4F3895
